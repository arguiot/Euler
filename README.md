...
The project was largely inspired by [TheoremJS](https://theorem.js.org], [SymPy](https://www.sympy.org/) and the [Wolfram Language](https://www.wolfram.com/language/)
