...
//  
//
//  Created by Arthur Guiot on 2020-01-06.
//
...
/// A way of representing hash function's digest
public struct Digest {
    public let digest: [Byte]
    
    /// Creates a new Digest
    /// - Parameter digest: The `utf8` array of bytes
    init(_ digest: [Byte]) {
        assert(digest.count == 16)
        self.digest = digest
    }
    
    /// MD5 representation of the `Digest`
...
/// Calculating a MD5 digest of bytes from bytes
/// - Parameter bytes: The `uft8` array of bytes
...
/// - Parameter digest: Array of `Byte` as `utf8` array
...
public extension String {
    /// MD5 encoding of the String
    var md5: String {
        return encodeMD5(digest: md5Digest)
    }
    
    /// MD5 Digest of the String as an array of `Byte`
    var md5Digest: [Byte] {
