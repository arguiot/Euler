...
public extension Tables {
    ...
    func CONVERT(_ n: BigDouble, from_unit: String, to_unit: String) throws -> BigDouble {
        ...
        let units: [Unit] = [
            ...
            Unit("cubic nautical mile", "Nmi3", ["Nmi^3"], "volume", false, true, BN("6352182208")!),
            ...
            Unit("light-year", "ly", nil, "length", false, true, BN("9460730472580800")!),
            ...
            Unit("parsec", "pc", ["parsec"], "length", false, true, BN("30856775814671900")!),
        ...
        let binary_prefixes: [String: BinaryPrefix] = [
            ...
            "Ei": BinaryPrefix("exbi", 60, BN("1152921504606846976")!, "Ei", "exa"),
            "Pi": BinaryPrefix("pebi", 50, BN("1125899906842624")!, "Pi", "peta"),
            "Ti": BinaryPrefix("tebi", 40, BN("1099511627776")!, "Ti", "tera"),
